                ...
                <div className="flex flex-col items-center md:items-start mt-3 px-2 w-full max-w-xl">
                  <div className="w-full flex flex-col md:flex-row justify-between items-center md:items-start gap-4">
                    ...
                    <div className="shrink-0">
                      <a href="/resume1.pdf" target="_blank" className="group relative flex items-center gap-2 px-4 py-2.5 rounded-xl overflow-hidden backdrop-blur-xl bg-gradient-to-r from-[#2563eb]/80 via-[#3b82f6]/80 to-[#06b6d4]/80 border border-gray-300 shadow-lg cursor-pointer hover:scale-105 transition-all duration-300">
